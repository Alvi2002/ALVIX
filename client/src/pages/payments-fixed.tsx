              ...
              {paymentMethods.deposit.map((method) => (
                <Card key={method.id} className="bg-card border-accent/20 overflow-hidden">
                  ...
                  <CardFooter className="bg-muted/10 pt-4">
                    <Button variant="default" className="w-full bg-accent hover:bg-accent/90 text-white">ডিপোজিট করুন</Button>
                  </CardFooter>
                </Card>
              ))}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {paymentMethods.withdraw.map((method) => (
                <Card key={method.id} className="bg-card border-accent/20 overflow-hidden">
                  ...
                  <CardFooter className="bg-muted/10 pt-4">
                    <Button variant="default" className="w-full bg-accent hover:bg-accent/90 text-white">উত্তোলন করুন</Button>
                  </CardFooter>
                </Card>
              ))}
            </div>
