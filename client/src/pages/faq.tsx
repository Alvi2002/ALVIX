...
export default function FAQPage() {
  ...
  const faqData = {
    account: [
      {
        id: "acc-1",
        question: "কিভাবে TK999 এ অ্যাকাউন্ট খুলবেন?",
        answer: "TK999 এ অ্যাকাউন্ট খোলা খুবই সহজ। হোমপেজে 'রেজিস্ট্রেশন' বাটনে ক্লিক করুন, ফর্মটি পূরণ করুন (ইউজারনেম, ইমেইল, পাসওয়ার্ড), আমাদের শর্তাবলী মেনে নিন, এবং 'রেজিস্টার' এ ক্লিক করুন। আপনার ইমেইল যাচাই করুন এবং আপনার অ্যাকাউন্ট ব্যবহারের জন্য প্রস্তুত।"
      },
      {
        id: "acc-2",
    ...
    payments: [
      ...
      },
      {
        ...
        answer: "ডিপোজিট বা উত্তোলন সমস্যার ক্ষেত্রে, অনুগ্রহ করে আমাদের 24/7 লাইভ চ্যাট সাপোর্ট বা payments@tk999.com এ যোগাযোগ করুন। আমাদের দক্ষ কাস্টমার সাপোর্ট টিম সাহায্য করবে। যোগাযোগ করার সময়, অনুগ্রহ করে ট্রানজেকশন আইডি, পেমেন্ট পদ্ধতি, পরিমাণ, এবং সমস্যার বিবরণ প্রদান করুন।"
      }
    ],
    games: [
      {
    ...
    security: [
      {
        id: "sec-1",
        question: "TK999 কিভাবে আমার ব্যক্তিগত তথ্য সুরক্ষিত রাখে?",
