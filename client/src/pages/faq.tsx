  ...
  const faqData = {
    ...
    games: [
      {
        ...
        answer: "ALVIX এ আমরা বিস্তৃত পরিসরের গেমিং অপশন অফার করি। এর মধ্যে রয়েছে ১০০০+ স্লট গেমস (ক্লাসিক স্লট, ভিডিও স্লট, জ্যাকপট স্লট), লাইভ কেসিনো গেমস (রুলেট, ব্ল্যাকজ্যাক, বাকারাত, পোকার), স্পোর্টস বেটিং (ফুটবল, ক্রিকেট, বাস্কেটবল, টেনিস), এবং বিশেষ গেমস যেমন ক্র্যাশ গেমস এবং লটারি।"
      },
      {
        id: "game-2",
        question: "গেমগুলো কি মোবাইলে খেলা যাবে?",
        answer: "হ্যাঁ, ALVIX সম্পূর্ণভাবে মোবাইল-ফ্রেন্ডলি। আমাদের সমস্ত গেম মোবাইল-অপ্টিমাইজড, যা আপনাকে আপনার স্মার্টফোন বা ট্যাবলেট থেকে যেকোন জায়গায় খেলতে দেয়। শুধু আপনার ব্রাউজারে আমাদের ওয়েবসাইট ভিজিট করুন এবং অ্যাপ ইনস্টল করা ছাড়াই খেলা শুরু করুন।"
      },
      {
        id: "game-3",
    ...
    security: [
      ...
      },
      {
        ...
        answer: "আপনার অ্যাকাউন্ট সুরক্ষিত রাখতে: শক্তিশালী, অনন্য পাসওয়ার্ড ব্যবহার করুন এবং এটি অন্য সাইটের সাথে শেয়ার করবেন না; 2FA সক্রিয় করুন; অফিসিয়াল ALVIX URL এ ভিজিট করছেন তা নিশ্চিত করুন; পাবলিক ওয়াই-ফাই ব্যবহার করার সময় VPN ব্যবহার করুন; সন্দেহজনক ইমেইল বা লিংক থেকে সতর্ক থাকুন; নিয়মিত আপনার অ্যাকাউন্ট অ্যাক্টিভিটি পর্যবেক্ষণ করুন; এবং আপনার ডিভাইস আপডেটেড রাখুন।"
      }
    ],
    support: [
      {
        ...
        answer: "আমাদের সাথে যোগাযোগ করার বিভিন্ন উপায় আছে: 24/7 লাইভ চ্যাট (ওয়েবসাইটের নীচে ডান কোণে আইকন), ইমেইল (support@alvix.com), ফোন (০১৭০০-০০০০০০), বা আমাদের 'যোগাযোগ' ফর্ম ব্যবহার করুন। আমাদের সাপোর্ট টিম সাহায্য করার জন্য সবসময় উপলব্ধ, দিনে ২৪ ঘন্টা, সপ্তাহে ৭ দিন।"
      },
      {
        id: "supp-2",
      ...
      {
        id: "supp-3",
        question: "ALVIX কি ভাষায় সাপোর্ট প্রদান করে?",
      ...
      },
      {
        ...
        answer: "অভিযোগ দায়ের করতে, আমাদের ওয়েবসাইটের 'যোগাযোগ' পৃষ্ঠায় যান এবং ফর্মে 'অভিযোগ' বিষয় সিলেক্ট করুন, অথবা complaints@alvix.com এ ইমেইল করুন। যথাসম্ভব বিস্তারিত তথ্য প্রদান করুন, যেমন সংশ্লিষ্ট ট্রানজেকশন আইডি, অ্যাকাউন্ট বিবরণ, এবং সমস্যার পূর্ণ বিবরণ। সমস্ত অভিযোগ ৪৮ ঘন্টার মধ্যে সম্বোধন করা হবে। জটিল সমস্যার জন্য, আমাদের অভিযোগ টিম ফিডব্যাক প্রদান করবে।"
      },
      {
        id: "supp-6",
        question: "মন্তব্য এবং সাজেশন দেব কিভাবে?",
        answer: "আমরা সর্বদা আমাদের সেবা উন্নত করতে মন্তব্য এবং সাজেশন স্বাগত জানাই। আমাদের 'ফিডব্যাক' ফর্ম পূরণ করুন, যা আমাদের হোমপেজের নীচে বা কাস্টমার সাপোর্ট সেকশনে পাওয়া যাবে। অথবা, আপনি feedback@alvix.com এ ইমেইল করতে পারেন। আপনার ফিডব্যাক আমাদের টিম পর্যালোচনা করবে, এবং আমরা প্রায়শই ব্যবহারকারীদের প্রস্তাবগুলো বাস্তবায়ন করি।"
      }
    ]
  };
