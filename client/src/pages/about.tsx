    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <main className="flex-grow container mx-auto px-4 py-6">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">TK999 - বাংলাদেশের অন্যতম সেরা অনলাইন গেমিং ও বেটিং প্ল্যাটফর্ম</p>
        </div>
            ...
            <CardContent className="pt-6">
              <div className="max-w-3xl mx-auto">
                ...
                <p className="mb-4 text-muted-foreground">
                  TK999 হল বাংলাদেশের অন্যতম প্রধান অনলাইন গেমিং ও বেটিং প্ল্যাটফর্ম, যা ২০২০ সালে প্রতিষ্ঠিত হয়েছিল। আমরা সর্বদা নিরাপদ, আধুনিক, এবং আনন্দদায়ক অনলাইন গেমিং অভিজ্ঞতা প্রদান করার জন্য প্রতিশ্রুতিবদ্ধ।
                </p>
                <p className="mb-4 text-muted-foreground">
